...
export const gameCatalog: GameCatalogEntry[] = [
  ...
  { key: "배틀그라운드", queries: ["PUBG BATTLEGROUNDS", "PlayerUnknown's Battlegrounds", "PUBG"], acceptedNames: ["PUBG: BATTLEGROUNDS", "PUBG BATTLEGROUNDS", "PLAYERUNKNOWN'S BATTLEGROUNDS", "PlayerUnknown's Battlegrounds"] },
  { key: "FC Online", queries: ["EA SPORTS FC Online", "FC Online", "FIFA Online 4"], acceptedNames: ["FC Online", "EA SPORTS FC Online", "EA SPORTS FC ONLINE", "FIFA Online 4"] },
  ...
  { key: "스타크래프트 2", queries: ["StarCraft II", "StarCraft 2"], acceptedNames: ["StarCraft II", "StarCraft 2"] },
  ...
  { key: "쿠키런: 킹덤", queries: ["CookieRun Kingdom", "Cookie Run Kingdom", "Cookie Run: Kingdom"], acceptedNames: ["CookieRun: Kingdom", "Cookie Run: Kingdom", "CookieRun Kingdom"] },
